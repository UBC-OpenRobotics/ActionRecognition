...
-----
## Labelling Data
- action_labeller.py is a GUI application that is meant to label images with the intention of training action recognition. It can be launched with `python3 action_labeller.py`. To run on the CPU, run `python3 action_labeller.py --use_cpu 1`.
